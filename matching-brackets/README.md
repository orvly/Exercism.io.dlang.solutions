# My solution
To make this exercise a little bit more interesting, I tried to use a @nogc approach, where instead
of using a dynamically allocated stack, I used the runtime stack instead, and passed the state
of the parser through it.
I also discovered that slicing which creates a smaller string is a @nogc operation, which was nice :-)
